...
const DocumentUpload: React.FC<Props> = ({ onUpload }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const attachments: DocumentAttachment[] = files.map(file => ({
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-md border border-slate-100">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button 
          type="submit"
          className="w-full bg-blue-600 text-white font-bold py-2 rounded-lg hover:bg-blue-700 transition shadow-lg active:scale-95 flex items-center justify-center"
        >
